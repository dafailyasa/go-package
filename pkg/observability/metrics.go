...
func InitMeterProvider(appName, version, environment, mode string) (*sdkmetric.MeterProvider, error) {
	var (
	...
	mp := sdkmetric.NewMeterProvider(
		...
		sdkmetric.WithResource(initResource(appName, version, environment)),
	)
