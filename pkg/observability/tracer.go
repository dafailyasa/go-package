...
func InitTracerProvider(appName, version, environment, mode string) (*sdktrace.TracerProvider, error) {
	var (
	...
	tracerProvider := sdktrace.NewTracerProvider(
		...
		sdktrace.WithResource(initResource(appName, version, environment)),
	)
